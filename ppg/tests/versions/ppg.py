...
def get_ppg_versions(distro_type):
    ...
    return {"ppg-11.5": get_pg11_versions(packages=["11+204-1", "204-1", '1:11-5', '11+210-1'],
            ...
            "ppg-18.3": get_pg18_versions(packages=["3:18.3-1", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-14.22": get_pg14_versions(packages=["2:14.22-1", "1:290-1", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-15.17": get_pg15_versions(packages=["2:15.17-1", "1:290-1", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-16.13": get_pg16_versions(packages=["2:16.13-1", "1:290-1", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-17.9": get_pg17_versions(packages=["2:17.9-1", "1:290-1", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-18.3": get_pg18_versions(packages=["3:18.3-1", "1:290-1", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
