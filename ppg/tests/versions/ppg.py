...
def get_ppg_versions(distro_type):
    ...
    return {"ppg-11.5": get_pg11_versions(packages=["11+204-1", "204-1", '1:11-5', '11+210-1'],
            ...
            "ppg-17.4": get_pg17_versions(packages=["2:17.4-1", "1:267-1", '267-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-13.20": get_pg13_versions(packages=["2:13.21-1", "1:277-1", '277-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-14.17": get_pg14_versions(packages=["2:14.18-1", "1:277-1", '277-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-15.12": get_pg15_versions(packages=["2:15.13-1", "1:277-1", '277-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-16.8": get_pg16_versions(packages=["2:16.9-1", "1:277-1", '277-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-17.4": get_pg17_versions(packages=["2:17.5-1", "1:277-1", '277-1'],
                                          distros=DISTROS, distro_type=distro_type),
            }
