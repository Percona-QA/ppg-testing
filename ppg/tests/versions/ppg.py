...
DISTROS = ['jammy', 'bookworm', 'noble', 'trixie', 'resolute']
...
def get_pg19_versions(distros, packages, distro_type):
    ppg_19_versions = {
                       "deb_packages": fill_template_form(DEB12_PACKAGES_TEMPLATE, "19"),
                       "deb_provides": fill_provides_template_form(DEB_PROVIDES_TEMPLATE, "19"),
                       "rpm7_provides": fill_provides_template_form(RPM7_PROVIDES_TEMPLATE, "19"),
                       'rpm_provides': fill_provides_template_form(RPM_PROVIDES_TEMPLATE, "19"),
                       "rpm_packages": fill_template_form(RPM_PG13PACKAGES_TEMPLATE, "19"),
                       "rpm7_packages": fill_template_form(RPM7_PG13PACKAGES_TEMPLATE, "19"),
                       "rhel_files": fill_template_form(RHEL_FILES_TEMPLATE, "19"),
                       "deb_files": fill_template_form(DEB_FILES_TEMPLATE, "19"),
                       "extensions": get_extensions(distro_type),
                       "binaries": ['clusterdb', 'createdb', 'createuser',
                                    'dropdb', 'dropuser', 'pg_basebackup',
                                    'pg_config', 'pg_dump', 'pg_dumpall',
    ...
    ppg_19_versions.update({"deb_pkg_ver": fill_package_versions(packages=packages,
                                                                 distros=distros)})
    return ppg_19_versions
...
def get_ppg_versions(distro_type):
    ...
    return {"ppg-14.0": get_pg14_versions(packages=["2:14.0-1", "1:226-1", '226-0'],
            ...
            "ppg-18.4": get_pg18_versions(packages=["3:18.4-2", "1:290-2", '290-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-14.24": get_pg14_versions(packages=["2:14.24-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-15.19": get_pg15_versions(packages=["2:15.19-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-16.15": get_pg16_versions(packages=["2:16.15-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-17.11": get_pg17_versions(packages=["2:17.11-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-18.6": get_pg18_versions(packages=["3:18.6-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-19.0": get_pg19_versions(packages=["3:19.0-1", "1:293-1", '293-1'],
                                          distros=DISTROS, distro_type=distro_type),
            }
