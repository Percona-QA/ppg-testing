...
def get_ppg_versions(distro_type):
    ...
    return {"ppg-11.5": get_pg11_versions(packages=["11+204-1", "204-1", '1:11-5', '11+210-1'],
            ...
            "ppg-18.1": get_pg18_versions(packages=["3:18.1-3", "1:287-1", '287-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-14.21": get_pg14_versions(packages=["2:14.21-2", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-15.16": get_pg15_versions(packages=["2:15.16-2", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-16.12": get_pg16_versions(packages=["2:16.12-2", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-17.8": get_pg17_versions(packages=["2:17.8-2", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            "ppg-18.2": get_pg18_versions(packages=["2:18.2-3", "1:289-1", '289-1'],
                                          distros=DISTROS, distro_type=distro_type),
            }
