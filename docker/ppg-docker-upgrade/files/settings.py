...
# since it's not a PSP build); pgbackrest stays 2.59.0, same as plain ppg-16.15.
# Key by ppg_version -> {settings key: value} to override just that key when
# is_psp is true; get_settings() applies it.
PSP_OVERRIDES = {
    "16.15": {
...
# PG 14: adminpack still present; pg_logicalinspect not yet available.
DOCKER_LIST_EXTENSIONS_PG14 = [e for e in DOCKER_LIST_EXTENSIONS if e != "pg_logicalinspect"]

# PG 15: adminpack still present; pg_logicalinspect not yet available.
DOCKER_LIST_EXTENSIONS_PG15 = [e for e in DOCKER_LIST_EXTENSIONS if e != "pg_logicalinspect"]
...
ppg_versions = {
    "14.22": {
        ...
        "extensions": DOCKER_LIST_EXTENSIONS_PG14,
        "binaries": [
            "clusterdb",
            "createdb",
            "createuser",
    ...
    "15.17": {
        ...
        "extensions": DOCKER_LIST_EXTENSIONS_PG15,
        "binaries": [
            "clusterdb",
            "createdb",
            "createuser",
