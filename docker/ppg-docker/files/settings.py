...
patroni = {
    ...
    "14.24": {"version": "4.1.5","binary_version": "patroni 4.1.5"},
    "15.19": {"version": "4.1.5","binary_version": "patroni 4.1.5"},
...
ppg_versions = {
    ...
    "14.23": {
        ...
        "percona-postgis35_14": postgis["14.23"],
        "percona-postgis35_14-client": postgis["14.23"],
        "percona-postgis35_14-gui": postgis["14.23"],
        "percona-postgis35_14-llvmjit": postgis["14.23"],
        "percona-postgis35_14-utils": postgis["14.23"],
        "rpm_packages": fill_template_form(DOCKER_RPM_PACKAGES_TEMPLATE, "14"),
        "rhel_files": fill_template_form(DOCKER_RHEL_FILES_TEMPLATE, "14"),
        "extensions": DOCKER_LIST_EXTENSIONS,
        "binaries": ['clusterdb', 'createdb', 'createuser',
    ...
    "15.18": {
        ...
        "percona-postgis35_15": postgis["15.18"],
        "percona-postgis35_15-client": postgis["15.18"],
        "percona-postgis35_15-gui": postgis["15.18"],
        "percona-postgis35_15-llvmjit": postgis["15.18"],
        "percona-postgis35_15-utils": postgis["15.18"],
        "rpm_packages": fill_template_form(DOCKER_RPM_PACKAGES_TEMPLATE, "15"),
        "rhel_files": fill_template_form(DOCKER_RHEL_FILES_TEMPLATE, "15"),
        "extensions": DOCKER_LIST_EXTENSIONS,
        "binaries": ['clusterdb', 'createdb', 'createuser',
